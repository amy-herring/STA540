...
Because of the nature of the course, we will encounter many more advanced topics that could easily be the subject of entire courses. For the benefit of those whose interest is piqued, I will post additional resources for further exploration. Part of the goal of this course is to learn how (and what!) to teach yourself in order to complete a project, but we'll also take an academic view and delve more deeply into topics, time permitting.
...
| [Professor Amy Herring](https://stat.duke.edu/people/amy-h-herring)  <a href="mailto:amy.herring@duke.edu" title="email"><i class="fa fa-envelope"></i></a> &nbsp;  | Weekdays 2:00-3:15pm EDT | Zoom (see Sakai) |
 [TA Rapha&euml;l Morsomme](https://stat.duke.edu/people/raphaël-morsomme-0)  <a href="mailto:raphael.morsomme@duke.edu" title="email"><i class="fa fa-envelope"></i></a> &nbsp;  | early and late | Zoom (see Sakai)
...
Texts and readings will be assigned as needed. We will support computation in R and RStudio. Students are free to use any software they wish as long as reproducibility requirements are met.


### Topics and Important Dates

STA 540 contain a mixture of short lecture, lab, and work sessions. Frequent mini-assessments will be provided to check mastery and identify areas for additional focus.

Note: this schedule is approximate and is likely to be modified as the course progresses. Some sessions may be swapped due to course timing. Assignments are due at noon EDT unless otherwise specified. 
...
| May 14    | Case Study 1: Dosing Donkeys  |   Getting to Know You Video |             
| May 15     | What is a Good Model?      |  Popes Assignment (Individual)     |
| May 18    | Simulations, Evaluating Models    |      |
| May 19   | Loss Functions  |  Individual Project Proposal   |
| May 20   | Q\&A |   |
| May 21  | Writing Methods, Results, and Discussion Sections | Case Study 1 (Report, Video, Reproducible Code); Feedback on Individual Proposals  |
...
| May 27  | Recap of Case Study 1; Longitudinal Data Analysis: Mixed Effects Model  | Individual Project Part I: Introduction and Data Description |
| May 28  | Mixed Effects Model, Covariance |   |
| May 29  | Missing Data |  Comments on Individual Project Part I |
...
| June 8   | Recap of Case Study 2 | Individual Project Part II: Methods and Preliminary Results (Report, Video, Reproducible Code) | 
| June 9   | Case Study 3: Wearables and Stress |  |
| June 10  |  | Comments on Individual Project Part II (peer and instructor) |
| June 11   |  |   |
| June 12    | |   |
| June 15  | |  | 
...
| June 19   | | Individual Project (Report, Video, Reproducible Code) | 
| June 22   | | Individual Project Comments (peer and instructor) |  
| June 25    | | Individual Report Response and Final Revision (due at 2pm) | 
