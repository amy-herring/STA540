...
<font color="#6CA0DC"><i class="fas fa-calendar-alt fa-lg"></i></font> &nbsp; MTWThF (office hours with instructor or TA, some live lectures 2:00-3:15pm to be recorded)
...
| ----------  | -------------------------------------         | ---- |
| [Professor Amy Herring](https://stat.duke.edu/people/amy-h-herring)  <a href="mailto:amy.herring@duke.edu" title="email"><i class="fa fa-envelope"></i></a> &nbsp;  | Tuesday and Thursday, 3:15-4:00 EDT and by appointment | Zoom (see Sakai) |
 [TA Rapha&euml;l Morsomme](https://stat.duke.edu/people/raphaël-morsomme-0)  <a href="mailto:raphael.morsomme@duke.edu" titele="email"><i class="fa fa-envelope"></i></a> &nbsp;  | Monday and Wednesday, 7:00-8:00pm EDT and by appointment | Zoom (see Sakai)
...
| June 8   | Case Study 3: Wearables and Stress |  Case Study 2 Response and Revision | 
| June 9   |  | Individual Project Submission II: Methods and Preliminary Results (Report, Video, Reproducible Code) |
| June 10  | Brinnae Bent, Big Ideas Lab |  |
| June 11   | Q&A With Brinnae (7pm) | Comments on Individual Project Submission II (peer and instructor)  |
| June 12    | Guest Lecture on Professional Opportunities: Prof David Banks |   
| June 15  | Individual Project Meetings |  | 
| June 16    | Lab | Case Study 3 (Report, Video, Reproducible Code)  | 
| June 17    |  |  Case Study 3 Comments (peer and instructor, including reproducibility) | 
| June 18   |  | Case Study 3 Response and Revision |
