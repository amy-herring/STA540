...
To find $\mu$ that minimizes the SSE$=y'y-2\beta'X'y+\beta'X'X\beta$ take derivatives:
...
<font size="3"> Row 1 tests if group 1 and group 2 are the same (both would have expected mean $\beta_0$); row 2 tests if group 1 and group 3 are the same, and row 3 tests if group 2 and group 3 are the same.</font> 
